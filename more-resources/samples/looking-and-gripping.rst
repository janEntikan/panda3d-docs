...
control_joint, you can manipulate the orientation of that joint in Panda
...
will also expose the hand joint using expose_joint and use its positional data
to "attach" objects that the character can hold. By using expose_joint, the
