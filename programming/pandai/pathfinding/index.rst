...
.. code-block:: python
   ...
   ai_behaviors.init_path_find(string filename)
...
.. code-block:: python
   ...
   ai_behaviors.path_find_to(NodePath np, string type)

   ai_behaviors.path_find_to(Vec3 pos, string type)
...
type as “add_path” else leave as default.
...
This functions work similar to add_static_obstacle except that in this case the
